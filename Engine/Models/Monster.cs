...
namespace Engine.Models
{
    public class Monster : LivingEntity
    {
        ...
        public Monster(int id, string name, string imageName,
                       int maximumHitPoints, int dexterity, int maximumStamina, int maximumMana, 
                       GameItem currentWeapon,
                       int rewardExperiencePoints, int gold) :
            base(name, maximumHitPoints, maximumHitPoints, dexterity, maximumStamina, maximumStamina, maximumMana, maximumMana, gold)
        {
            ID = id;
            ImageName = imageName;
        ...
        public Monster GetNewInstance()
        {
            ...
            Monster newMonster =
                new Monster(ID, Name, ImageName, MaximumHitPoints, Dexterity, MaximumStamina, MaximumMana,
