...
namespace TestEngine.Models
{
    ...
    public class TestInventory
    {
        ...
        public void Test_AddItem()
        {
            ...
            Inventory inventory1 = inventory.AddItemFromFactory(9001);
        ...
        public void Test_AddItems()
        {
            ...
            itemsToAdd.Add(ItemFactory.CreateGameItem(9001));
            itemsToAdd.Add(ItemFactory.CreateGameItem(9002));
            ...
            Inventory inventory2 =
                inventory1
                    .AddItemFromFactory(9001)
                    .AddItemFromFactory(9002);
        ...
        public void Test_RemoveItemQuantities()
        {
            ...
            Assert.AreEqual(2, inventory2.Items.Count(i => i.ItemTypeID == 9001));
            ...
            Assert.AreEqual(2, inventory3.Items.Count(i => i.ItemTypeID == 9001));
            ...
            Assert.AreEqual(2, inventory4.Items.Count(i => i.ItemTypeID == 9001));
        }
